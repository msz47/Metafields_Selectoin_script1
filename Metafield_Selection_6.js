...
/*<script>*/
    let url = "@Html.Raw(ViewBag.BaseUrl)";
{/*</script>*/}


fetch('https://41b9-124-109-62-57.ngrok-free.app/GiftShip/GetAppUrl')  // Adjust the route if necessary
...
function getMetafields(shopName, productId) {
    if (shopName && productId) {
        $.ajax({
            url: `https://41b9-124-109-62-57.ngrok-free.app/GiftShip/GetMetafields?shopName=${shopName}&productId=${productId}`,
            type: "POST",
            contentType: "application/json;charset=utf-8",
            dataType: "json",
            success: function (data) {
    ...
    if (metafiledOption) {
        ...
        customButton.addEventListener("click", function (event) {
            ...
            if (shopName && cartId) {
                ...
                $.ajax({
                    url: `https://41b9-124-109-62-57.ngrok-free.app/GiftShip/MetafieldsCheckout?ShopName=${shopName}&CartId=${cartId}`,
                    type: "POST",
                    contentType: "application/json;charset=utf-8",
                    dataType: "json",
                    success: function (data) {
...
function addToCart(ShopName, CartId, MerchandiseId, quantity, options) {
    if (ShopName) {
        ...
        $.ajax({
            url: `https://41b9-124-109-62-57.ngrok-free.app/GiftShip/CustomCartLineAdd?ShopName=${ShopName}&CartId=${CartId}&MerchandiseId=${MerchandiseId}&Quantity=${quantity}`,
...
function directCheckou6t(ShopName, MerchandiseId, quantity, options) {
    if (ShopName) {
        $.ajax({
            url: `https://41b9-124-109-62-57.ngrok-free.app/GiftShip/CreateDirectCheckout?ShopName=${ShopName}&MerchandiseId=${MerchandiseId}&Quantity=${quantity}`,
            data: JSON.stringify(options),
            type: "POST",
            contentType: "application/json",
            dataType: "json",
