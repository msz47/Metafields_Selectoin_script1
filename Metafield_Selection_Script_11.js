    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (data) {
				...
				url = "https://41b9-124-109-62-57.ngrok-free.app/";
			}
			if(url){
				if (window.location.pathname.includes("/products/")) {
					porductPageAction();
				}
				else if(window.location.pathname.endsWith("/cart") || window.location.pathname.endsWith("/cart/")){
					cartPageAction();
				}
			}
        },
